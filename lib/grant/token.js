 ...
 *
 *     function({client, user, res, req, locals}, done) { ... }
 *
 ...
 * Examples:
 *
 *     server.grant(oauth2orize.grant.token(function({client, user, res}, done) {}
 *       AccessToken.create(client, user, res.scope, function(err, accessToken) {
